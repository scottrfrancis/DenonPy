...
python3 denon-control.py -e home.local -r certs/rhome.gg.cert.pem -c certs/23c079a990.cert.pem -k certs/23c079a990.private.key -n "Denon" -h "192.168.4.35" -t 0.5
